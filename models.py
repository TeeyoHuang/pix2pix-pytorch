...
class Discriminator(nn.Module):
    def __init__(self, args):
        ...
        self.model = nn.Sequential(
            *discriminator_block(self.in_channels*2, 64, normalization=False),
...
class Discriminator_n_layers(nn.Module):
    def __init__(self, args ):
        ...
        sequence += [*discriminator_block(num_of_filter, 1, k=4, s=2, p=1, norm=False, sigmoid=True)]
